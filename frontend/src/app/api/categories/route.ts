export async function GET() {
    ...
    try {
        ...
        const response = await fetch(`${BASE_URL}/api/categories?populate[Image][fields]=url,alternativeText&populate[product_categories][populate][Image][fields]=url,alternativeText`);
        if (!response.ok) {
